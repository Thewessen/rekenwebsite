var Oefening = {
	schrijfwijze: 	{
		uitleg: function()	{
			return "Schrijf de verhoudingen zo klein mogelijk op.";
		},
		vraag:	function()	{
			return 	VerhoudingInWoorden(GlobalVar.a[GlobalVar.i-1],GlobalVar.b[GlobalVar.i-1]) + " is hetzelfde als <span id='Answer" + GlobalVar.i + "' class='input box'>" + FillDots("",GlobalVar.e[GlobalVar.i-1]) + "</span> " + " : <span id='Answer" + GlobalVar.i + "b' class='input'>" + FillDots("",GlobalVar.f[GlobalVar.i-1]) + "</span>.";
		},
		check:	function()	{
		...
		settings: [[10,10,10,3],[99,99,10,3]],
		niveau: 1,
		...
		voorbeeld: function()	{
			var text = "<p>Deze verhouding kun je schrijven als " + GlobalVar.a[GlobalVar.i-1] + " : " + GlobalVar.b[GlobalVar.i-1] + "</p>";
			text += "<p>" + vbVerkleinVerhouding(GlobalVar.a[GlobalVar.i-1],GlobalVar.b[GlobalVar.i-1]) + "</p>";
			return text;
		},
		antwoord: function()	{
		...
		correctie: function()	{
			return GlobalVar.e[GlobalVar.i-1] + " : " + GlobalVar.f[GlobalVar.i-1];
		}
	},
	alsbreuk:	{
		uitleg:	function()	{
			var text = "Schrijf de volgende verhouding als breuk.";
		...
		vraag:	function()	{
			return 	GlobalVar.a[GlobalVar.i-1] + " : " + GlobalVar.b[GlobalVar.i-1] + " is hetzelfde als " + Breuk("<span id='Answer" + GlobalVar.i + "' class='inputbreuk teller onderstreep box'>" + FillDots("",GlobalVar.e[GlobalVar.i-1]) + "</span>","<span id='Answer" + GlobalVar.i + "b' class='inputbreuk'>" + FillDots("",GlobalVar.f[GlobalVar.i-1]) + "</span>");
		},
		check:	function()	{
			if (GlobalVar.respons1/GlobalVar.respons2==GlobalVar.e[GlobalVar.i-1]/GlobalVar.f[GlobalVar.i-1])	{
				return true;
			} else {
				return false;
			};
		},
		settings: [[10,10,0,0],[999,999,0,0],[10,10,5,3],[20,20,20,3]],
		niveau: 1,
		niveau1: "Kleine getallen, niet vereenvoudigen.",
		niveau2: "Grote getallen, niet vereenvoudigen.",
		niveau3: "Kleine getallen, breuk verder vereenvoudigen.",
		niveau4: "Grote getallen, breuk verder vereenvoudigen.",
		getallen:	function()	{
			var getallen = [];
			do {
				getallen = Breuken(this.settings[GlobalVar.niveau-1][0],this.settings[GlobalVar.niveau-1][1],this.settings[GlobalVar.niveau-1][2],this.settings[GlobalVar.niveau-1][3]);
		...
		voorbeeld: function()	{
			var text = GlobalVar.a[GlobalVar.i-1] + " : " + GlobalVar.b[GlobalVar.i-1] + " is hetzelfde als " + Frac(GlobalVar.a[GlobalVar.i-1],GlobalVar.b[GlobalVar.i-1]);
			text = "<p>" + text + "</p>";
			if(GlobalVar.niveau>2) {
				text += "<p>" + vbVereenvoudig(GlobalVar.a[GlobalVar.i-1],GlobalVar.b[GlobalVar.i-1]) + "</p>";
			}
			text += "<p>Het antwoord is " + this.correctie() + ".</p>"; 
			return text;
		},
		antwoord: function()	{
			if (GlobalVar.respons2.toString().length=="")	{
	...
	procenten:	{
		uitleg:	function()	{
			var text = "Schrijf de volgende procenten als een verhouding.";
			if	(GlobalVar.niveau<2)	{
				return	text + "<br>Je hoeft de verhouding nog <strong>niet</strong> zo klein mogelijk te schrijven.";
			}	else	{
				return	text + "<br>Schrijf de verhouding <strong>zo klein mogelijk</strong> op.";
			};
		},
		vraag:	function()	{
			return 	GlobalVar.a[GlobalVar.i-1] + "% is hetzelfde als <span id='Answer" + GlobalVar.i + "' class='input box'>" + FillDots("",GlobalVar.e[GlobalVar.i-1]) + "</span> " + " : <span id='Answer" + GlobalVar.i + "b' class='input'>" + FillDots("",GlobalVar.f[GlobalVar.i-1]) + "</span>";
		},
		check:	function()	{
			if (GlobalVar.respons1==GlobalVar.e[GlobalVar.i-1] && GlobalVar.respons2==GlobalVar.f[GlobalVar.i-1])	{
				return true;
		...
		settings: [[100,0,0,0],[10,0,10,3],[50,0,10,3]],
		niveau: 1,
		niveau1: "Procent als verhouding, niet kleiner schrijven.",
		niveau2: "Procent als verhouding, mogelijk kleiner schrijven.",
		niveau3: "Procent als verhouding, kleiner schrijven.",
		getallen:	function()	{
			var getallen = [];
			do {
				getallen = Breuken(this.settings[GlobalVar.niveau-1][0],this.settings[GlobalVar.niveau-1][1],this.settings[GlobalVar.niveau-1][2],this.settings[GlobalVar.niveau-1][3]);
				...
				if (GlobalVar.niveau<2)	{
					...
					var vereenvoudigd = Vereenvoudig(getallen[0],100);
					getallen.push(vereenvoudigd[0]);
					getallen.push(vereenvoudigd[1]);
				}
			} while(SameExercise(getallen))
		...
		voorbeeld: function()	{
			var text = "Procent (%) betekend 'van de 100'."
			text = "<p>" + text + "</p>";
			text += "<p>" + GlobalVar.a[GlobalVar.i-1] + "% is hetzelfde als " + GlobalVar.a[GlobalVar.i-1] + " : 100</p>";
			if(GlobalVar.niveau>1) {
				text += "<p>" + vbVerkleinVerhouding(GlobalVar.a[GlobalVar.i-1],100) + "</p>";
			}
			return text;
		},
		antwoord: function()	{
	...
	alsprocent:	{
		uitleg:	function()	{
			var text = "Schrijf de volgende verhouding als procent.";
			if (GlobalVar.niveau===3) {
				text += "<br>En rond af op <strong>twee decimalen</strong>.";
			};
			return text;
		},
		vraag:	function()	{
			return 	VerhoudingInWoorden(GlobalVar.a[GlobalVar.i-1],GlobalVar.b[GlobalVar.i-1]) + " is <span id='Answer" + GlobalVar.i + "' class='input box'>" + FillDots("",GlobalVar.e[GlobalVar.i-1]) + "</span>%";
		},
		check:	function()	{
		...
		settings: [[100,0,0,0],[100,0,0,0],[100,0,0,0]],
		niveau: 1,
		niveau1: "Verhouding van de 100 als procent.",
		niveau2: "Verhouding als procent, eenvoudig rekenen naar 100.",
		niveau3: "Verhouding als procent, afronden op twee decimalen.",
		getallen:	function()	{
			var getallen = [];
			do {
				getallen = Breuken(this.settings[GlobalVar.niveau-1][0],this.settings[GlobalVar.niveau-1][1],this.settings[GlobalVar.niveau-1][2],this.settings[GlobalVar.niveau-1][3]);
				...
				if (GlobalVar.niveau===1)	{
					...
					getallen[1]=100;
					getallen.push("");
				} else if (GlobalVar.niveau===2) {
					var delersvanhonderd = [2,4,5,10,20,25,50];
					var deler = delersvanhonderd[Math.floor(Math.random()*delersvanhonderd.length)];
					getallen[0] = Math.floor(getallen[0]/deler);
					getallen[1] = 100/deler;
					getallen.push(getallen[0]*deler);
					getallen.push("");
				} else {
					getallen.push(Math.round(100/getallen[1]*getallen[0]*100)/100);
					getallen.push("");
				};
			} while(getallen[0]===0 || SameExercise(getallen))
			PushGetallen(getallen);
		},
		voorbeeld: function()	{
			var text = "Procent (%) betekend 'van de 100'."
	...
	procentvan:	{
		uitleg:	function()	{
			var text = "Bereken de percentage van het gegeven aantal.";
			if (GlobalVar.niveau===3) {
				text += "<br>En rond af op <strong>twee decimalen</strong>.";
			};
			return text;
		...
		vraag:	function()	{
			return 	GlobalVar.a[GlobalVar.i-1] + "% van " + GlobalVar.b[GlobalVar.i-1] + " is <span id='Answer" + GlobalVar.i + "' class='input box'>" + FillDots("",GlobalVar.e[GlobalVar.i-1]) + "</span>";
		},
		check:	function()	{
			if (GlobalVar.respons1==GlobalVar.e[GlobalVar.i-1])	{
				return true;
		...
		settings: [[100,100,0,0],[100,10,0,0],[100,100,0,0]],
		niveau: 1,
		niveau1: "Percentage berekenen van de 100.",
		niveau2: "Percentage berekenen met hele getallen als antwoord.",
		niveau3: "Percentage bereken, afronden op twee decimalen.",
		getallen:	function()	{
			var getallen = [];
			do {
				getallen = Breuken(this.settings[GlobalVar.niveau-1][0],this.settings[GlobalVar.niveau-1][1],this.settings[GlobalVar.niveau-1][2],this.settings[GlobalVar.niveau-1][3]);
				...
				if (GlobalVar.niveau===1)	{
					...
					var delersvanhonderd = [2,4,5,10,20,25,50];
					var deler = delersvanhonderd[Math.floor(Math.random()*delersvanhonderd.length)];
					getallen[0] = 100/deler;
					getallen.push(getallen[1]);
					getallen[1] = getallen[1]*deler;
					getallen.push("");
				} else {
					getallen.push(Math.round(getallen[1]/100*getallen[0]*100)/100);
					getallen.push("");
				};
			} while(getallen[0]===0 || SameExercise(getallen))
			PushGetallen(getallen);
...
function vbVerkleinVerhouding(a,b)	{
	var GGD = 1;
	var x = a;
	var y = b;
	for(i=0;i<GlobalVar.primes.length;)	{
	...
	if(GGD==1)	{
		return "Deze verhouding is niet kleiner te schrijven."
	} else {
		var text = "Schrijf de verhouding ze klein mogelijk door beide getallen te delen door " + GGD + ".<br>";
		text += a + " : " + GGD + " = " + x + "<br>";
		text += b + " : " + GGD + " = " + y + "<br>";
		text += a + " : " + b + " is hetzelfde als " + x + " : " + y;
		return text;
	};
};

function VerhoudingInWoorden(a,b) {
	var woorden = [" van de ", " op de ", " staat tot "];
	return a + woorden[Math.floor(Math.random() * 3)] + b;
}
